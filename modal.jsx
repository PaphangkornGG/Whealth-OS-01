...
const TICKER_SUGGESTIONS = [
  ...
  { t: 'V',     n: 'Visa Inc.',                cls: 'US Stock' },
  { t: 'MA',    n: 'Mastercard Inc.',          cls: 'US Stock' },
  { t: 'JPM',   n: 'JPMorgan Chase',           cls: 'US Stock' },
  { t: 'BAC',   n: 'Bank of America',          cls: 'US Stock' },
  { t: 'GS',    n: 'Goldman Sachs',            cls: 'US Stock' },
  { t: 'JNJ',   n: 'Johnson & Johnson',        cls: 'US Stock' },
  { t: 'UNH',   n: 'UnitedHealth Group',       cls: 'US Stock' },
  { t: 'PFE',   n: 'Pfizer Inc.',              cls: 'US Stock' },
  { t: 'ABBV',  n: 'AbbVie Inc.',              cls: 'US Stock' },
  { t: 'WMT',   n: 'Walmart Inc.',             cls: 'US Stock' },
  { t: 'COST',  n: 'Costco Wholesale',         cls: 'US Stock' },
  { t: 'HD',    n: 'Home Depot',               cls: 'US Stock' },
  { t: 'MCD',   n: "McDonald's Corp.",         cls: 'US Stock' },
  { t: 'SBUX',  n: 'Starbucks Corp.',          cls: 'US Stock' },
  { t: 'NKE',   n: 'Nike Inc.',                cls: 'US Stock' },
  { t: 'DIS',   n: 'Walt Disney Co.',          cls: 'US Stock' },
  { t: 'NFLX',  n: 'Netflix Inc.',             cls: 'US Stock' },
  { t: 'ORCL',  n: 'Oracle Corp.',             cls: 'US Stock' },
  { t: 'INTC',  n: 'Intel Corp.',              cls: 'US Stock' },
  { t: 'QCOM',  n: 'Qualcomm Inc.',            cls: 'US Stock' },
  { t: 'AVGO',  n: 'Broadcom Inc.',            cls: 'US Stock' },
  { t: 'CRM',   n: 'Salesforce Inc.',          cls: 'US Stock' },
  { t: 'NOW',   n: 'ServiceNow Inc.',          cls: 'US Stock' },
  { t: 'PLTR',  n: 'Palantir Technologies',    cls: 'US Stock' },
  { t: 'XOM',   n: 'Exxon Mobil Corp.',        cls: 'US Stock' },
  { t: 'CVX',   n: 'Chevron Corp.',            cls: 'US Stock' },
  { t: 'BRK.B', n: 'Berkshire Hathaway B',     cls: 'US Stock' },
  { t: 'LLY',   n: 'Eli Lilly and Co.',        cls: 'US Stock' },
  { t: 'SPOT',  n: 'Spotify Technology',       cls: 'US Stock' },
  { t: 'UBER',  n: 'Uber Technologies',        cls: 'US Stock' },
  { t: 'LYFT',  n: 'Lyft Inc.',                cls: 'US Stock' },
  { t: 'COIN',  n: 'Coinbase Global',          cls: 'US Stock' },
  { t: 'HOOD',  n: 'Robinhood Markets',        cls: 'US Stock' },
